...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">ثبت حمل و نقل</li>
@endsection
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mb-4">ثبت حمل و نقل</h4>
            ...
            <div class="card-body">
                <form action="{{ route('shipping.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                @foreach($provinces as $province)
                                    <div class="form-check d-flex align-items-center mb-2">
                                        <input class="form-check-input me-2" type="checkbox"
                                            ...
                                            {{ old('provinces.'.$province->id.'.selected') ? 'checked' : '' }}>
                                        ...
                                        <input type="number" name="provinces[{{ $province->id }}][price]"
                                               ...
                                               value="{{ old('provinces.'.$province->id.'.price') }}"
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <button type="submit" class="btn btn-success">ثبت حمل و نقل</button>
                    </div>
                </form>
            </div>
        </div>
